...
namespace Tributech.Dataspace.ClientExamples {
    class Program {
        ...
        private const string nodeUrl = "https://data-api.development-tributech.dataspace.network";
        private const string tokenUrl = "https://id.development-tributech.dataspace.network/connect/token";
        private const string scope = "195d0b59-2113-4d67-ac6c-7116595e413b-full-access";
        private const string clientId = "195d0b59-2113-4d67-ac6c-7116595e413b";
        private const string clientSecret = "793da246-d86a-5b95-daf1-a16c507f062e";
